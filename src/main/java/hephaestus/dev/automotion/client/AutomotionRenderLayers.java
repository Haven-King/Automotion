...
public class AutomotionRenderLayers extends RenderLayer {
	...
	public static RenderLayer TRANSLUCENT_UNLIT = of("automotion:translucent", VertexFormats.POSITION_COLOR, 7, 2097152, false, true, RenderLayer.MultiPhaseParameters.builder().transparency(RenderPhase.TRANSLUCENT_TRANSPARENCY).build(true));
